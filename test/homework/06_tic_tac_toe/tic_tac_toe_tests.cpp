...
//     game.mark_board(7);
//     REQUIRE(game.game_over());
//     REQUIRE(game.get_winner() == "X"); // Validate winner as "X"
// }
...
//     game.mark_board(8);
//     REQUIRE(game.game_over());
//     REQUIRE(game.get_winner() == "X"); // Winner should be "X"
// }
...
// //     REQUIRE(game.get_winner() == "X"); // Winner should be "X"
// // }
// TEST_CASE("Verify function check_diagonal_win, from top right", "[tic_tac_toe]") {
//     tic_tac_toe game;
//     game.start_game("X");
//     game.mark_board(3); // X
//     game.mark_board(1); // O
